...
class PozoSaneamientoModel(Base):
    ...
    red_viene_de_pozo_2 = Column(String(50))
    red_va_a_pozo_2 = Column(String(50))
    colector_mat_entrada_2 = Column(String(50))
    colector_diametro_entrada_mm_2 = Column(Integer)
    colector_mat_salida_2 = Column(String(50))
    colector_diametro_salida_mm_2 = Column(Integer)
    ruta_foto_situacion = Column(String(255))
    ruta_foto_interior = Column(String(255))
    ruta_foto_esquema = Column(String(255))
