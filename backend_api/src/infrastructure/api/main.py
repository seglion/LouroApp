...
def create_inspeccion(
    ...
    inspeccion = Inspeccion(
        ...
        red_viene_de_pozo_2=request.red_viene_de_pozo_2,
        red_va_a_pozo_2=request.red_va_a_pozo_2,
        ...
        colector_mat_entrada_2=request.colector_mat_entrada_2,
        colector_diametro_entrada_mm_2=request.colector_diametro_entrada_mm_2,
        colector_mat_salida_2=request.colector_mat_salida_2,
        colector_diametro_salida_mm_2=request.colector_diametro_salida_mm_2,
        ruta_foto_situacion=request.ruta_foto_situacion,
        ruta_foto_interior=request.ruta_foto_interior,
        ruta_foto_esquema=request.ruta_foto_esquema,
