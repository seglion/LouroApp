    ...
    try:
        ...
        if x_val is not None and y_val is not None:
            ...
            row_data = {
                ...
                "resalto_altura_cm": float(pozo.get("resalto_altura_cm") or 0) if pozo.get("resalto_altura_cm") is not None else None,
            ...
            schema = {
                ...
                "properties": {
                    ...
                    "largo_pozo_mm": "int", "ancho_pozo_mm": "int", "resalto": "str", "resalto_altura_cm": "float",
