...
# Configuración a través de Entorno
...
def process_gis_message(ch, method, properties, body):
    ...
    try:
        ...
        # TODO: Añadir aquí llamadas a Módulo MinIO y Módulo Fiona/GeoPandas
        logger.info(f"⏳ Procesando inspección del pozo: {message.get('payload', {}).get('pozo', {}).get('id_pozo')}")
        
        # Simulamos trabajo por el momento...
        time.sleep(1)
